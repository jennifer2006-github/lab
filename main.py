...
# MODIFIED: Changed from 365 days to 50 days
def random_date_in_past_50_days():
    today = datetime.now()
    start_date = today - timedelta(days=50)
    random_days = random.randint(0, 49)
...
def main():
    ...
    for i in range(num_commits):
        # MODIFIED: Calling the updated function here
        commit_date = random_date_in_past_50_days()
